              ...
              <div class="col-lg-12">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <section class="section-form">
                    ...
                    <transition name="slide-fade">
                      <form v-show="step===1" action="javascript:void(0)" @submit.prevent="next"
                        ...
                        <div v-show="currency !== null && donation_type !== null" class="form-outline mb-4">
                          ...
                          <input type="text" name="amount" v-model.number="amount" id="amount" class="form-control"/>
                        </div>
                    ...
                    <transition name="slide-fade">
                      <form v-show="step===3" action="javascript:void(0)" @submit.prevent="next"
                            class="row col-8 m-auto" method="post">
                        <div class="form-outline mb-4">
                    ...
                    <transition name="slide-fade">
                      <form v-show="step===4" action="javascript:void(0)" @submit.prevent="pay"
                            class="row col-8 m-auto" method="post">

                        <div class="form-outline mb-4">
                          <img class="payment-info" :src="asset('images/1.png')" alt="payment info"/>
                        </div>
...
import Requisites from "./Payment/Requisites.vue";
...
export default {
  ...
  methods: {
    ...
    async pay() {
      ...
      let url = '/api/payment-register';

      if (this.$store.state.auth.authenticated) {
        console.log('cansoli lok')
        url = '/api/payment';
      }
